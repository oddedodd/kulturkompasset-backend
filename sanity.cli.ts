...
export default defineCliConfig({
  ...
  deployment: {
    autoUpdates: true,
    // Peker på det eksisterende studioet kulturkompasset.sanity.studio,
    // slik at `sanity deploy` treffer riktig app uten å spørre om hostname.
    appId: 'nkz6ql4mor8w2q2lneokk7ji',
  },
})
